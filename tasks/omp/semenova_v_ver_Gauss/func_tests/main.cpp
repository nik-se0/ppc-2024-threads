...
#include "omp/semenova_v_ver_Gauss/include/ops_omp.hpp"
...
TEST(semenova_v_ver_Gauss_omp, Creat_empty_task) {
  int n = 3;
  int m = 3;
...
TEST(semenova_v_ver_Gauss_omp, Creat_task_with_empty_outputs_and_inputs) {
  int n = 3;
  int m = 3;
  std::vector<int> image(n * m);
  std::vector<int> filteredImage(n * m);
...
TEST(semenova_v_ver_Gauss_omp, Creat_task_without_inputs1) {
  int n = 3;
  int m = 3;
  std::vector<int> image(n * m);
  std::vector<int> filteredImage(n * m);
...
TEST(semenova_v_ver_Gauss_omp, Creat_task_without_inputs2) {
  int n = 3;
  int m = 3;
  std::vector<int> image(n * m);
  std::vector<int> filteredImage(n * m);
...
TEST(semenova_v_ver_Gauss_omp, Creat_task_without_inputs3) {
  int n = 3;
  int m = 3;
  std::vector<int> image(n * m);
  std::vector<int> filteredImage(n * m);
...
TEST(semenova_v_ver_Gauss_omp, Creat_task_without_outputs1) {
  int n = 3;
  int m = 3;
  std::vector<int> image(n * m);
  std::vector<int> filteredImage(n * m);
...
TEST(semenova_v_ver_Gauss_omp, Creat_task_without_outputs2) {
  int n = 3;
  int m = 3;
  std::vector<int> image(n * m);
  std::vector<int> filteredImage(n * m);
...
TEST(semenova_v_ver_Gauss_omp, Creat_task_without_outputs3) {
  int n = 3;
  int m = 3;
  std::vector<int> image(n * m);
  std::vector<int> filteredImage(n * m);
...
TEST(semenova_v_ver_Gauss_omp, Creat_task_with_wrong_matrix_size1) {
  int n = 3;
  int m = 3;
  int a = 6;
  int b = 6;
...
TEST(semenova_v_ver_Gauss_omp, Creat_task_with_wrong_matrix_size2) {
  int n = 2;
  int m = 2;
  std::vector<int> image(n * m);
  std::vector<int> filteredImage(n * m);
...
TEST(semenova_v_ver_Gauss_omp, Creat_task_with_outputs_and_inputs1) {
  int n = 3;
  int m = 3;
  std::vector<int> image(n * m);
  std::vector<int> filteredImage(n * m);
...
TEST(semenova_v_ver_Gauss_omp, Creat_task_with_outputs_and_inputs2) {
  int n = 3;
  int m = 3;
  std::vector<int> image(n * m);
  std::vector<int> filteredImage(n * m);
...
TEST(semenova_v_ver_Gauss_omp, Run_task1) {
  int n = 3;
  int m = 3;
  std::vector<int> image(n * m);
  std::vector<int> filteredImage(n * m);
...
TEST(semenova_v_ver_Gauss_omp, Run_task2) {
  int n = 3;
  int m = 3;
  std::vector<int> image(n * m);
  std::vector<int> filteredImage(n * m);
...
TEST(semenova_v_ver_Gauss_omp, Task_post_processing1) {
  int n = 3;
  int m = 3;
  std::vector<int> image(n * m);
  std::vector<int> filteredImage(n * m);
...
TEST(semenova_v_ver_Gauss_omp, Task_post_processing2) {
  int n = 3;
  int m = 3;
  std::vector<int> image(n * m);
  std::vector<int> filteredImage(n * m);
...
TEST(semenova_v_ver_Gauss_omp, Task_run_correct1) {
  int n = 3;
  int m = 3;
  std::vector<int> image(n * m);
  std::vector<int> filteredImage(n * m);
...
TEST(semenova_v_ver_Gauss_omp, Task_run_correct2) {
  int n = 4;
  int m = 4;
  std::vector<int> image(n * m);
  std::vector<int> filteredImage(n * m);
...
TEST(semenova_v_ver_Gauss_omp, Task_correct_pre_processing) {
  int n = 4;
  int m = 4;
  std::vector<int> image(n * m);
  std::vector<int> filteredImage(n * m);
...
TEST(semenova_v_ver_Gauss_omp, Task_correct_with_random_image) {
  int n = 10;
  int m = 10;
  std::vector<int> image(n * m);
  std::vector<int> filteredImage(n * m);
